...
tokenizer = T5Tokenizer.from_pretrained("t5-small", extra_ids=100)
...
model.resize_token_embeddings(len(tokenizer))  # Critical alignment
...
trainer.train()
model.save_pretrained("transformer-model/models/trained/t5_chatbot")